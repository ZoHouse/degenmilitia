...
var ICONS = {
  add: async () => (await import("./add-K7PAMCN4.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-NGPQSG5G.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-E3YJM2TR.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-QJPTXURG.js")).appStoreSvg,
  apple: async () => (await import("./apple-VDQYZTEH.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-FNKSHZTQ.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-6V75FLFL.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-4FWT6VIX.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-Z42ZB3NA.js")).arrowTopSvg,
  bank: async () => (await import("./bank-IHB3UQDC.js")).bankSvg,
  browser: async () => (await import("./browser-OTQWTEMN.js")).browserSvg,
  card: async () => (await import("./card-AJLL3AGI.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-YBVY43YC.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-2FY5LPYS.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-U4E7352X.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-WMZEANBD.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-RWCDKAJX.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-CBVGGKOT.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-DLPE4W2M.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-HAG3X6IU.js")).clockSvg,
  close: async () => (await import("./close-M7AEFUSG.js")).closeSvg,
  compass: async () => (await import("./compass-7UJ5XIRS.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-UXHI6RO7.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-PNLS53XF.js")).copySvg,
  cursor: async () => (await import("./cursor-DRKRYL6F.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-L7QME6GX.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-5DJGLBGP.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-LUCNS2K6.js")).disconnectSvg,
  discord: async () => (await import("./discord-SABMFTGV.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-QRXYZSGA.js")).etherscanSvg,
  extension: async () => (await import("./extension-JGI2QST7.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-EATR2UEC.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-IJZBBSTK.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-BDJD3JJK.js")).farcasterSvg,
  filters: async () => (await import("./filters-US2XBTD7.js")).filtersSvg,
  github: async () => (await import("./github-STMYAFTK.js")).githubSvg,
  google: async () => (await import("./google-35TI73T7.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-UEPG5HCW.js")).helpCircleSvg,
  image: async () => (await import("./image-CPX3JV4V.js")).imageSvg,
  id: async () => (await import("./id-AHIVXOSL.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-JRATDVNO.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-O7SHWJFY.js")).lightbulbSvg,
  mail: async () => (await import("./mail-BRZQMS2T.js")).mailSvg,
  mobile: async () => (await import("./mobile-2CTJR4JE.js")).mobileSvg,
  more: async () => (await import("./more-MZAG4VRV.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-PTL4KF7S.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-EO2PXQZF.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-RP46GKMU.js")).offSvg,
  playStore: async () => (await import("./play-store-BSFHZWCV.js")).playStoreSvg,
  plus: async () => (await import("./plus-3B5XFRAO.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-TO24W3LN.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-EGMSORK3.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-KCJY7FA2.js")).refreshSvg,
  search: async () => (await import("./search-BQLQ4Z26.js")).searchSvg,
  send: async () => (await import("./send-ACNN437I.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-KIOKR3CT.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-SO2GDMOD.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-4QXWURR5.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-XRFSV3T3.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-5I6E7GAV.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-4CUY5YVQ.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-ZUWLCPCC.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-V7UMIPZO.js")).twitchSvg,
  twitter: async () => (await import("./x-ZDIH2XNN.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-ZGGG375B.js")).twitterIconSvg,
  verify: async () => (await import("./verify-ZTTE5LQP.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-V2SVX6J2.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-ZZVNWJ4U.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-IWTHSCXF.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-IWTHSCXF.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-IWTHSCXF.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-4LN5O4TS.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-CYRFNVHD.js")).warningCircleSvg,
  x: async () => (await import("./x-ZDIH2XNN.js")).xSvg,
  info: async () => (await import("./info-4I2TERSR.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-OWQCQ42M.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-IMJGETAD.js")).reownSvg
};
...
lit-html/development/directive-helpers.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-XMMH7DAR.js.map
